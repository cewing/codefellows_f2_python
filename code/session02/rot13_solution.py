...
## NOTE: if you didn't discover bytearray, you can build with a loop
...
if __name__ == "__main__":
    ...
    solution = "Magnetic from outside near corner"
    assert rot13a("Zntargvp sebz bhgfvqr arne pbeare") == solution
    assert rot13b("Zntargvp sebz bhgfvqr arne pbeare")  == solution
    assert rot13c("Zntargvp sebz bhgfvqr arne pbeare")  == solution

    ## rot13 should be reversible:
    sample = 'This Should be the Same...'
    assert rot13a(rot13b('This Should be the Same...')) == sample
    assert rot13b(rot13c('This Should be the Same...')) == sample
    assert rot13c(rot13a('This Should be the Same...')) == sample

    print "Yup -- they all passed!"



# ## and some timings:
# In [2]: timeit rot13a('This is a pretty short string, but maybe long enough to test')
# 10000 loops, best of 3: 52.2 us per loop
# 
# In [3]: timeit rot13b('This is a pretty short string, but maybe long enough to test')
# 10000 loops, best of 3: 54.7 us per loop
# 
